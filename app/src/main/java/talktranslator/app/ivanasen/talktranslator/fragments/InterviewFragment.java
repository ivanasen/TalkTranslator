...
public class InterviewFragment extends Fragment implements ITextToSpeechUser, RecognitionListener {

    private final String LOG_TAG = InterviewFragment.class.getSimpleName();
